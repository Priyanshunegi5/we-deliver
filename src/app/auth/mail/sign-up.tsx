...
export default function Page()  {
  ...
  /**
   * Handle mail sign up logic.
   *
   * @return void
   */
  const handleMailSignUp = () => {
    // Handle mail sign up logic here
  }
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.suggestContainer}>
          <Text style={styles.suggest}>{t('Already have account?')}</Text>

          <Text style={styles.suggest}>
            <Button onPress={() => redirectToMailSignIn()}>
              {t('Sign In')}
            </Button>
          </Text>
        </View>
